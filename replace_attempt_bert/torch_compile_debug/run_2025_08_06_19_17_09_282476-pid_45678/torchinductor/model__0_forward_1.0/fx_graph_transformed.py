class GraphModule(torch.nn.Module):
    def forward(self, primals_1: "i64[1, 128]", primals_2: "f16[50257, 768]", primals_3: "f16[1024, 768]", primals_4: "i64[1, 128]", primals_5: "f16[768]", primals_6: "f16[768]", primals_7: "f16[2304]", primals_8: "f16[768, 2304]", primals_9: "f16[768]", primals_10: "f16[768, 768]", primals_11: "f16[768]", primals_12: "f16[768]", primals_13: "f16[3072]", primals_14: "f16[768, 3072]", primals_15: "f16[768]", primals_16: "f16[3072, 768]", primals_17: "f16[768]", primals_18: "f16[768]", primals_19: "f16[2304]", primals_20: "f16[768, 2304]", primals_21: "f16[768]", primals_22: "f16[768, 768]", primals_23: "f16[768]", primals_24: "f16[768]", primals_25: "f16[3072]", primals_26: "f16[768, 3072]", primals_27: "f16[768]", primals_28: "f16[3072, 768]", primals_29: "f16[768]", primals_30: "f16[768]", primals_31: "f16[2304]", primals_32: "f16[768, 2304]", primals_33: "f16[768]", primals_34: "f16[768, 768]", primals_35: "f16[768]", primals_36: "f16[768]", primals_37: "f16[3072]", primals_38: "f16[768, 3072]", primals_39: "f16[768]", primals_40: "f16[3072, 768]", primals_41: "f16[768]", primals_42: "f16[768]", primals_43: "f16[2304]", primals_44: "f16[768, 2304]", primals_45: "f16[768]", primals_46: "f16[768, 768]", primals_47: "f16[768]", primals_48: "f16[768]", primals_49: "f16[3072]", primals_50: "f16[768, 3072]", primals_51: "f16[768]", primals_52: "f16[3072, 768]", primals_53: "f16[768]", primals_54: "f16[768]", primals_55: "f16[2304]", primals_56: "f16[768, 2304]", primals_57: "f16[768]", primals_58: "f16[768, 768]", primals_59: "f16[768]", primals_60: "f16[768]", primals_61: "f16[3072]", primals_62: "f16[768, 3072]", primals_63: "f16[768]", primals_64: "f16[3072, 768]", primals_65: "f16[768]", primals_66: "f16[768]", primals_67: "f16[2304]", primals_68: "f16[768, 2304]", primals_69: "f16[768]", primals_70: "f16[768, 768]", primals_71: "f16[768]", primals_72: "f16[768]", primals_73: "f16[3072]", primals_74: "f16[768, 3072]", primals_75: "f16[768]", primals_76: "f16[3072, 768]", primals_77: "f16[768]", primals_78: "f16[768]"):
        ...
        view: "i64[1, 128]" = torch.ops.aten.reshape.default(primals_1, [-1, 128]);  primals_1 = None
        ...
        view_1: "i64[1, 128]" = torch.ops.aten.reshape.default(primals_4, [1, -1]);  primals_4 = None
        ...
        view_2: "i64[128, 1]" = torch.ops.aten.reshape.default(iota, [128, 1]);  iota = None
        ...
        index: "b8[1, 128]" = torch.ops.aten.index.Tensor(convert_element_type, [view_4, add_1]);  convert_element_type = view_4 = add_1 = None
         ...
         # File: /usr/local/lib/python3.12/dist-packages/torch/_dynamo/_trace_wrapped_higher_order_op.py:142 in __torch_function__, code: return func(*args, **(kwargs or {}))
        view_5: "b8[1, 1, 128]" = torch.ops.aten.reshape.default(index, [1, 1, 128]);  index = None
        ...
        view_6: "b8[1, 1, 128, 128]" = torch.ops.aten.reshape.default(bitwise_and_1, [1, 1, 128, 128]);  bitwise_and_1 = None
        ...
        view_7: "f16[128, 768]" = torch.ops.aten.reshape.default(convert_element_type_2, [-1, 768]);  convert_element_type_2 = None
        
        # No stacktrace found for following nodes
        mm_default_17: "f16[128, 2304]" = torch.ops.aten.mm.default(view_7, primals_8)
        add_tensor_17: "f16[128, 2304]" = torch.ops.aten.add.Tensor(mm_default_17, primals_7);  mm_default_17 = primals_7 = None
        
         # File: /usr/local/lib/python3.12/dist-packages/transformers/pytorch_utils.py:117 in forward, code: x = x.view(size_out)
        view_8: "f16[1, 128, 2304]" = torch.ops.aten.reshape.default(add_tensor_17, [1, 128, 2304]);  add_tensor_17 = None
        ...
        view_9: "f16[1, 128, 12, 64]" = torch.ops.aten.reshape.default(getitem_3, [1, 128, -1, 64]);  getitem_3 = None
        ...
        view_10: "f16[1, 128, 12, 64]" = torch.ops.aten.reshape.default(getitem_4, [1, 128, -1, 64]);  getitem_4 = None
        ...
        view_11: "f16[1, 128, 12, 64]" = torch.ops.aten.reshape.default(getitem_2, [1, 128, -1, 64]);  getitem_2 = None
        ...
        view_12: "f16[1, 128, 768]" = torch.ops.aten.reshape.default(permute_3, [1, 128, -1]);  permute_3 = None
        
         # File: /usr/local/lib/python3.12/dist-packages/transformers/pytorch_utils.py:116 in forward, code: x = torch.addmm(self.bias, x.view(-1, x.size(-1)), self.weight)
        view_13: "f16[128, 768]" = torch.ops.aten.reshape.default(view_12, [-1, 768]);  view_12 = None
        
        # No stacktrace found for following nodes
        mm_default_16: "f16[128, 768]" = torch.ops.aten.mm.default(view_13, primals_10);  view_13 = None
        add_tensor_16: "f16[128, 768]" = torch.ops.aten.add.Tensor(mm_default_16, primals_9);  mm_default_16 = primals_9 = None
        
         # File: /usr/local/lib/python3.12/dist-packages/transformers/pytorch_utils.py:117 in forward, code: x = x.view(size_out)
        view_14: "f16[1, 128, 768]" = torch.ops.aten.reshape.default(add_tensor_16, [1, 128, 768]);  add_tensor_16 = None
        ...
        convert_element_type_10: "f16[1, 128, 768]" = torch.ops.prims.convert_element_type.default(add_6, torch.float16);  add_6 = None
         ...
         # File: /usr/local/lib/python3.12/dist-packages/transformers/pytorch_utils.py:116 in forward, code: x = torch.addmm(self.bias, x.view(-1, x.size(-1)), self.weight)
        view_15: "f16[128, 768]" = torch.ops.aten.reshape.default(convert_element_type_10, [-1, 768]);  convert_element_type_10 = None
        addmm_2: "f16[128, 3072]" = torch.ops.aten.addmm.default(primals_13, view_15, primals_14);  primals_13 = None
        
         # File: /usr/local/lib/python3.12/dist-packages/transformers/pytorch_utils.py:117 in forward, code: x = x.view(size_out)
        view_16: "f16[1, 128, 3072]" = torch.ops.aten.reshape.default(addmm_2, [1, 128, 3072])
        ...
        mul_7: "f16[1, 128, 3072]" = torch.ops.aten.mul.Tensor(mul_4, add_8);  mul_4 = add_8 = None
         ...
         # File: /usr/local/lib/python3.12/dist-packages/transformers/pytorch_utils.py:116 in forward, code: x = torch.addmm(self.bias, x.view(-1, x.size(-1)), self.weight)
        view_17: "f16[128, 3072]" = torch.ops.aten.reshape.default(mul_7, [-1, 3072]);  mul_7 = None
        
        # No stacktrace found for following nodes
        mm_default_15: "f16[128, 768]" = torch.ops.aten.mm.default(view_17, primals_16)
        add_tensor_15: "f16[128, 768]" = torch.ops.aten.add.Tensor(mm_default_15, primals_15);  mm_default_15 = primals_15 = None
        
         # File: /usr/local/lib/python3.12/dist-packages/transformers/pytorch_utils.py:117 in forward, code: x = x.view(size_out)
        view_18: "f16[1, 128, 768]" = torch.ops.aten.reshape.default(add_tensor_15, [1, 128, 768]);  add_tensor_15 = None
        ...
        convert_element_type_18: "f16[1, 128, 768]" = torch.ops.prims.convert_element_type.default(add_11, torch.float16);  add_11 = None
         ...
         # File: /usr/local/lib/python3.12/dist-packages/transformers/pytorch_utils.py:116 in forward, code: x = torch.addmm(self.bias, x.view(-1, x.size(-1)), self.weight)
        view_19: "f16[128, 768]" = torch.ops.aten.reshape.default(convert_element_type_18, [-1, 768]);  convert_element_type_18 = None
        
        # No stacktrace found for following nodes
        mm_default_14: "f16[128, 2304]" = torch.ops.aten.mm.default(view_19, primals_20)
        add_tensor_14: "f16[128, 2304]" = torch.ops.aten.add.Tensor(mm_default_14, primals_19);  mm_default_14 = primals_19 = None
        
         # File: /usr/local/lib/python3.12/dist-packages/transformers/pytorch_utils.py:117 in forward, code: x = x.view(size_out)
        view_20: "f16[1, 128, 2304]" = torch.ops.aten.reshape.default(add_tensor_14, [1, 128, 2304]);  add_tensor_14 = None
        ...
        getitem_15: "f16[1, 128, 768]" = split_1[2];  split_1 = None
         ...
         # File: /usr/local/lib/python3.12/dist-packages/transformers/models/gpt2/modeling_gpt2.py:314 in forward, code: key_states = key_states.view(shape_kv).transpose(1, 2)
        view_21: "f16[1, 128, 12, 64]" = torch.ops.aten.reshape.default(getitem_14, [1, 128, -1, 64]);  getitem_14 = None
        permute_4: "f16[1, 12, 128, 64]" = torch.ops.aten.permute.default(view_21, [0, 2, 1, 3]);  view_21 = None
        
         # File: /usr/local/lib/python3.12/dist-packages/transformers/models/gpt2/modeling_gpt2.py:315 in forward, code: value_states = value_states.view(shape_kv).transpose(1, 2)
        view_22: "f16[1, 128, 12, 64]" = torch.ops.aten.reshape.default(getitem_15, [1, 128, -1, 64]);  getitem_15 = None
        permute_5: "f16[1, 12, 128, 64]" = torch.ops.aten.permute.default(view_22, [0, 2, 1, 3]);  view_22 = None
        
         # File: /usr/local/lib/python3.12/dist-packages/transformers/models/gpt2/modeling_gpt2.py:318 in forward, code: query_states = query_states.view(shape_q).transpose(1, 2)
        view_23: "f16[1, 128, 12, 64]" = torch.ops.aten.reshape.default(getitem_13, [1, 128, -1, 64]);  getitem_13 = None
        ...
        permute_7: "f16[1, 128, 12, 64]" = torch.ops.aten.permute.default(getitem_16, [0, 2, 1, 3])
         ...
         # File: /usr/local/lib/python3.12/dist-packages/transformers/models/gpt2/modeling_gpt2.py:356 in forward, code: attn_output = attn_output.reshape(*attn_output.shape[:-2], -1).contiguous()
        view_24: "f16[1, 128, 768]" = torch.ops.aten.reshape.default(permute_7, [1, 128, -1]);  permute_7 = None
        
         # File: /usr/local/lib/python3.12/dist-packages/transformers/pytorch_utils.py:116 in forward, code: x = torch.addmm(self.bias, x.view(-1, x.size(-1)), self.weight)
        view_25: "f16[128, 768]" = torch.ops.aten.reshape.default(view_24, [-1, 768]);  view_24 = None
        
        # No stacktrace found for following nodes
        mm_default_13: "f16[128, 768]" = torch.ops.aten.mm.default(view_25, primals_22);  view_25 = None
        add_tensor_13: "f16[128, 768]" = torch.ops.aten.add.Tensor(mm_default_13, primals_21);  mm_default_13 = primals_21 = None
        
         # File: /usr/local/lib/python3.12/dist-packages/transformers/pytorch_utils.py:117 in forward, code: x = x.view(size_out)
        view_26: "f16[1, 128, 768]" = torch.ops.aten.reshape.default(add_tensor_13, [1, 128, 768]);  add_tensor_13 = None
        ...
        convert_element_type_26: "f16[1, 128, 768]" = torch.ops.prims.convert_element_type.default(add_14, torch.float16);  add_14 = None
         ...
         # File: /usr/local/lib/python3.12/dist-packages/transformers/pytorch_utils.py:116 in forward, code: x = torch.addmm(self.bias, x.view(-1, x.size(-1)), self.weight)
        view_27: "f16[128, 768]" = torch.ops.aten.reshape.default(convert_element_type_26, [-1, 768]);  convert_element_type_26 = None
        addmm_6: "f16[128, 3072]" = torch.ops.aten.addmm.default(primals_25, view_27, primals_26);  primals_25 = None
        
         # File: /usr/local/lib/python3.12/dist-packages/transformers/pytorch_utils.py:117 in forward, code: x = x.view(size_out)
        view_28: "f16[1, 128, 3072]" = torch.ops.aten.reshape.default(addmm_6, [1, 128, 3072])
        ...
        mul_15: "f16[1, 128, 3072]" = torch.ops.aten.mul.Tensor(mul_12, add_16);  mul_12 = add_16 = None
         ...
         # File: /usr/local/lib/python3.12/dist-packages/transformers/pytorch_utils.py:116 in forward, code: x = torch.addmm(self.bias, x.view(-1, x.size(-1)), self.weight)
        view_29: "f16[128, 3072]" = torch.ops.aten.reshape.default(mul_15, [-1, 3072]);  mul_15 = None
        
        # No stacktrace found for following nodes
        mm_default_12: "f16[128, 768]" = torch.ops.aten.mm.default(view_29, primals_28)
        add_tensor_12: "f16[128, 768]" = torch.ops.aten.add.Tensor(mm_default_12, primals_27);  mm_default_12 = primals_27 = None
        
         # File: /usr/local/lib/python3.12/dist-packages/transformers/pytorch_utils.py:117 in forward, code: x = x.view(size_out)
        view_30: "f16[1, 128, 768]" = torch.ops.aten.reshape.default(add_tensor_12, [1, 128, 768]);  add_tensor_12 = None
        ...
        convert_element_type_34: "f16[1, 128, 768]" = torch.ops.prims.convert_element_type.default(add_19, torch.float16);  add_19 = None
         ...
         # File: /usr/local/lib/python3.12/dist-packages/transformers/pytorch_utils.py:116 in forward, code: x = torch.addmm(self.bias, x.view(-1, x.size(-1)), self.weight)
        view_31: "f16[128, 768]" = torch.ops.aten.reshape.default(convert_element_type_34, [-1, 768]);  convert_element_type_34 = None
        
        # No stacktrace found for following nodes
        mm_default_11: "f16[128, 2304]" = torch.ops.aten.mm.default(view_31, primals_32)
        add_tensor_11: "f16[128, 2304]" = torch.ops.aten.add.Tensor(mm_default_11, primals_31);  mm_default_11 = primals_31 = None
        
         # File: /usr/local/lib/python3.12/dist-packages/transformers/pytorch_utils.py:117 in forward, code: x = x.view(size_out)
        view_32: "f16[1, 128, 2304]" = torch.ops.aten.reshape.default(add_tensor_11, [1, 128, 2304]);  add_tensor_11 = None
        ...
        getitem_26: "f16[1, 128, 768]" = split_2[2];  split_2 = None
         ...
         # File: /usr/local/lib/python3.12/dist-packages/transformers/models/gpt2/modeling_gpt2.py:314 in forward, code: key_states = key_states.view(shape_kv).transpose(1, 2)
        view_33: "f16[1, 128, 12, 64]" = torch.ops.aten.reshape.default(getitem_25, [1, 128, -1, 64]);  getitem_25 = None
        permute_8: "f16[1, 12, 128, 64]" = torch.ops.aten.permute.default(view_33, [0, 2, 1, 3]);  view_33 = None
        
         # File: /usr/local/lib/python3.12/dist-packages/transformers/models/gpt2/modeling_gpt2.py:315 in forward, code: value_states = value_states.view(shape_kv).transpose(1, 2)
        view_34: "f16[1, 128, 12, 64]" = torch.ops.aten.reshape.default(getitem_26, [1, 128, -1, 64]);  getitem_26 = None
        permute_9: "f16[1, 12, 128, 64]" = torch.ops.aten.permute.default(view_34, [0, 2, 1, 3]);  view_34 = None
        
         # File: /usr/local/lib/python3.12/dist-packages/transformers/models/gpt2/modeling_gpt2.py:318 in forward, code: query_states = query_states.view(shape_q).transpose(1, 2)
        view_35: "f16[1, 128, 12, 64]" = torch.ops.aten.reshape.default(getitem_24, [1, 128, -1, 64]);  getitem_24 = None
        ...
        permute_11: "f16[1, 128, 12, 64]" = torch.ops.aten.permute.default(getitem_27, [0, 2, 1, 3])
         ...
         # File: /usr/local/lib/python3.12/dist-packages/transformers/models/gpt2/modeling_gpt2.py:356 in forward, code: attn_output = attn_output.reshape(*attn_output.shape[:-2], -1).contiguous()
        view_36: "f16[1, 128, 768]" = torch.ops.aten.reshape.default(permute_11, [1, 128, -1]);  permute_11 = None
        
         # File: /usr/local/lib/python3.12/dist-packages/transformers/pytorch_utils.py:116 in forward, code: x = torch.addmm(self.bias, x.view(-1, x.size(-1)), self.weight)
        view_37: "f16[128, 768]" = torch.ops.aten.reshape.default(view_36, [-1, 768]);  view_36 = None
        
        # No stacktrace found for following nodes
        mm_default_10: "f16[128, 768]" = torch.ops.aten.mm.default(view_37, primals_34);  view_37 = None
        add_tensor_10: "f16[128, 768]" = torch.ops.aten.add.Tensor(mm_default_10, primals_33);  mm_default_10 = primals_33 = None
        
         # File: /usr/local/lib/python3.12/dist-packages/transformers/pytorch_utils.py:117 in forward, code: x = x.view(size_out)
        view_38: "f16[1, 128, 768]" = torch.ops.aten.reshape.default(add_tensor_10, [1, 128, 768]);  add_tensor_10 = None
        ...
        convert_element_type_42: "f16[1, 128, 768]" = torch.ops.prims.convert_element_type.default(add_22, torch.float16);  add_22 = None
         ...
         # File: /usr/local/lib/python3.12/dist-packages/transformers/pytorch_utils.py:116 in forward, code: x = torch.addmm(self.bias, x.view(-1, x.size(-1)), self.weight)
        view_39: "f16[128, 768]" = torch.ops.aten.reshape.default(convert_element_type_42, [-1, 768]);  convert_element_type_42 = None
        addmm_10: "f16[128, 3072]" = torch.ops.aten.addmm.default(primals_37, view_39, primals_38);  primals_37 = None
        
         # File: /usr/local/lib/python3.12/dist-packages/transformers/pytorch_utils.py:117 in forward, code: x = x.view(size_out)
        view_40: "f16[1, 128, 3072]" = torch.ops.aten.reshape.default(addmm_10, [1, 128, 3072])
        ...
        mul_23: "f16[1, 128, 3072]" = torch.ops.aten.mul.Tensor(mul_20, add_24);  mul_20 = add_24 = None
         ...
         # File: /usr/local/lib/python3.12/dist-packages/transformers/pytorch_utils.py:116 in forward, code: x = torch.addmm(self.bias, x.view(-1, x.size(-1)), self.weight)
        view_41: "f16[128, 3072]" = torch.ops.aten.reshape.default(mul_23, [-1, 3072]);  mul_23 = None
        
        # No stacktrace found for following nodes
        mm_default_9: "f16[128, 768]" = torch.ops.aten.mm.default(view_41, primals_40)
        add_tensor_9: "f16[128, 768]" = torch.ops.aten.add.Tensor(mm_default_9, primals_39);  mm_default_9 = primals_39 = None
        
         # File: /usr/local/lib/python3.12/dist-packages/transformers/pytorch_utils.py:117 in forward, code: x = x.view(size_out)
        view_42: "f16[1, 128, 768]" = torch.ops.aten.reshape.default(add_tensor_9, [1, 128, 768]);  add_tensor_9 = None
        ...
        convert_element_type_50: "f16[1, 128, 768]" = torch.ops.prims.convert_element_type.default(add_27, torch.float16);  add_27 = None
         ...
         # File: /usr/local/lib/python3.12/dist-packages/transformers/pytorch_utils.py:116 in forward, code: x = torch.addmm(self.bias, x.view(-1, x.size(-1)), self.weight)
        view_43: "f16[128, 768]" = torch.ops.aten.reshape.default(convert_element_type_50, [-1, 768]);  convert_element_type_50 = None
        
        # No stacktrace found for following nodes
        mm_default_8: "f16[128, 2304]" = torch.ops.aten.mm.default(view_43, primals_44)
        add_tensor_8: "f16[128, 2304]" = torch.ops.aten.add.Tensor(mm_default_8, primals_43);  mm_default_8 = primals_43 = None
        
         # File: /usr/local/lib/python3.12/dist-packages/transformers/pytorch_utils.py:117 in forward, code: x = x.view(size_out)
        view_44: "f16[1, 128, 2304]" = torch.ops.aten.reshape.default(add_tensor_8, [1, 128, 2304]);  add_tensor_8 = None
        ...
        getitem_37: "f16[1, 128, 768]" = split_3[2];  split_3 = None
         ...
         # File: /usr/local/lib/python3.12/dist-packages/transformers/models/gpt2/modeling_gpt2.py:314 in forward, code: key_states = key_states.view(shape_kv).transpose(1, 2)
        view_45: "f16[1, 128, 12, 64]" = torch.ops.aten.reshape.default(getitem_36, [1, 128, -1, 64]);  getitem_36 = None
        permute_12: "f16[1, 12, 128, 64]" = torch.ops.aten.permute.default(view_45, [0, 2, 1, 3]);  view_45 = None
        
         # File: /usr/local/lib/python3.12/dist-packages/transformers/models/gpt2/modeling_gpt2.py:315 in forward, code: value_states = value_states.view(shape_kv).transpose(1, 2)
        view_46: "f16[1, 128, 12, 64]" = torch.ops.aten.reshape.default(getitem_37, [1, 128, -1, 64]);  getitem_37 = None
        permute_13: "f16[1, 12, 128, 64]" = torch.ops.aten.permute.default(view_46, [0, 2, 1, 3]);  view_46 = None
        
         # File: /usr/local/lib/python3.12/dist-packages/transformers/models/gpt2/modeling_gpt2.py:318 in forward, code: query_states = query_states.view(shape_q).transpose(1, 2)
        view_47: "f16[1, 128, 12, 64]" = torch.ops.aten.reshape.default(getitem_35, [1, 128, -1, 64]);  getitem_35 = None
        ...
        permute_15: "f16[1, 128, 12, 64]" = torch.ops.aten.permute.default(getitem_38, [0, 2, 1, 3])
         ...
         # File: /usr/local/lib/python3.12/dist-packages/transformers/models/gpt2/modeling_gpt2.py:356 in forward, code: attn_output = attn_output.reshape(*attn_output.shape[:-2], -1).contiguous()
        view_48: "f16[1, 128, 768]" = torch.ops.aten.reshape.default(permute_15, [1, 128, -1]);  permute_15 = None
        
         # File: /usr/local/lib/python3.12/dist-packages/transformers/pytorch_utils.py:116 in forward, code: x = torch.addmm(self.bias, x.view(-1, x.size(-1)), self.weight)
        view_49: "f16[128, 768]" = torch.ops.aten.reshape.default(view_48, [-1, 768]);  view_48 = None
        
        # No stacktrace found for following nodes
        mm_default_7: "f16[128, 768]" = torch.ops.aten.mm.default(view_49, primals_46);  view_49 = None
        add_tensor_7: "f16[128, 768]" = torch.ops.aten.add.Tensor(mm_default_7, primals_45);  mm_default_7 = primals_45 = None
        
         # File: /usr/local/lib/python3.12/dist-packages/transformers/pytorch_utils.py:117 in forward, code: x = x.view(size_out)
        view_50: "f16[1, 128, 768]" = torch.ops.aten.reshape.default(add_tensor_7, [1, 128, 768]);  add_tensor_7 = None
        ...
        convert_element_type_58: "f16[1, 128, 768]" = torch.ops.prims.convert_element_type.default(add_30, torch.float16);  add_30 = None
         ...
         # File: /usr/local/lib/python3.12/dist-packages/transformers/pytorch_utils.py:116 in forward, code: x = torch.addmm(self.bias, x.view(-1, x.size(-1)), self.weight)
        view_51: "f16[128, 768]" = torch.ops.aten.reshape.default(convert_element_type_58, [-1, 768]);  convert_element_type_58 = None
        addmm_14: "f16[128, 3072]" = torch.ops.aten.addmm.default(primals_49, view_51, primals_50);  primals_49 = None
        
         # File: /usr/local/lib/python3.12/dist-packages/transformers/pytorch_utils.py:117 in forward, code: x = x.view(size_out)
        view_52: "f16[1, 128, 3072]" = torch.ops.aten.reshape.default(addmm_14, [1, 128, 3072])
        ...
        mul_31: "f16[1, 128, 3072]" = torch.ops.aten.mul.Tensor(mul_28, add_32);  mul_28 = add_32 = None
         ...
         # File: /usr/local/lib/python3.12/dist-packages/transformers/pytorch_utils.py:116 in forward, code: x = torch.addmm(self.bias, x.view(-1, x.size(-1)), self.weight)
        view_53: "f16[128, 3072]" = torch.ops.aten.reshape.default(mul_31, [-1, 3072]);  mul_31 = None
        
        # No stacktrace found for following nodes
        mm_default_6: "f16[128, 768]" = torch.ops.aten.mm.default(view_53, primals_52)
        add_tensor_6: "f16[128, 768]" = torch.ops.aten.add.Tensor(mm_default_6, primals_51);  mm_default_6 = primals_51 = None
        
         # File: /usr/local/lib/python3.12/dist-packages/transformers/pytorch_utils.py:117 in forward, code: x = x.view(size_out)
        view_54: "f16[1, 128, 768]" = torch.ops.aten.reshape.default(add_tensor_6, [1, 128, 768]);  add_tensor_6 = None
        ...
        convert_element_type_66: "f16[1, 128, 768]" = torch.ops.prims.convert_element_type.default(add_35, torch.float16);  add_35 = None
         ...
         # File: /usr/local/lib/python3.12/dist-packages/transformers/pytorch_utils.py:116 in forward, code: x = torch.addmm(self.bias, x.view(-1, x.size(-1)), self.weight)
        view_55: "f16[128, 768]" = torch.ops.aten.reshape.default(convert_element_type_66, [-1, 768]);  convert_element_type_66 = None
        
        # No stacktrace found for following nodes
        mm_default_5: "f16[128, 2304]" = torch.ops.aten.mm.default(view_55, primals_56)
        add_tensor_5: "f16[128, 2304]" = torch.ops.aten.add.Tensor(mm_default_5, primals_55);  mm_default_5 = primals_55 = None
        
         # File: /usr/local/lib/python3.12/dist-packages/transformers/pytorch_utils.py:117 in forward, code: x = x.view(size_out)
        view_56: "f16[1, 128, 2304]" = torch.ops.aten.reshape.default(add_tensor_5, [1, 128, 2304]);  add_tensor_5 = None
        ...
        getitem_48: "f16[1, 128, 768]" = split_4[2];  split_4 = None
         ...
         # File: /usr/local/lib/python3.12/dist-packages/transformers/models/gpt2/modeling_gpt2.py:314 in forward, code: key_states = key_states.view(shape_kv).transpose(1, 2)
        view_57: "f16[1, 128, 12, 64]" = torch.ops.aten.reshape.default(getitem_47, [1, 128, -1, 64]);  getitem_47 = None
        permute_16: "f16[1, 12, 128, 64]" = torch.ops.aten.permute.default(view_57, [0, 2, 1, 3]);  view_57 = None
        
         # File: /usr/local/lib/python3.12/dist-packages/transformers/models/gpt2/modeling_gpt2.py:315 in forward, code: value_states = value_states.view(shape_kv).transpose(1, 2)
        view_58: "f16[1, 128, 12, 64]" = torch.ops.aten.reshape.default(getitem_48, [1, 128, -1, 64]);  getitem_48 = None
        permute_17: "f16[1, 12, 128, 64]" = torch.ops.aten.permute.default(view_58, [0, 2, 1, 3]);  view_58 = None
        
         # File: /usr/local/lib/python3.12/dist-packages/transformers/models/gpt2/modeling_gpt2.py:318 in forward, code: query_states = query_states.view(shape_q).transpose(1, 2)
        view_59: "f16[1, 128, 12, 64]" = torch.ops.aten.reshape.default(getitem_46, [1, 128, -1, 64]);  getitem_46 = None
        ...
        permute_19: "f16[1, 128, 12, 64]" = torch.ops.aten.permute.default(getitem_49, [0, 2, 1, 3])
         ...
         # File: /usr/local/lib/python3.12/dist-packages/transformers/models/gpt2/modeling_gpt2.py:356 in forward, code: attn_output = attn_output.reshape(*attn_output.shape[:-2], -1).contiguous()
        view_60: "f16[1, 128, 768]" = torch.ops.aten.reshape.default(permute_19, [1, 128, -1]);  permute_19 = None
        
         # File: /usr/local/lib/python3.12/dist-packages/transformers/pytorch_utils.py:116 in forward, code: x = torch.addmm(self.bias, x.view(-1, x.size(-1)), self.weight)
        view_61: "f16[128, 768]" = torch.ops.aten.reshape.default(view_60, [-1, 768]);  view_60 = None
        
        # No stacktrace found for following nodes
        mm_default_4: "f16[128, 768]" = torch.ops.aten.mm.default(view_61, primals_58);  view_61 = None
        add_tensor_4: "f16[128, 768]" = torch.ops.aten.add.Tensor(mm_default_4, primals_57);  mm_default_4 = primals_57 = None
        
         # File: /usr/local/lib/python3.12/dist-packages/transformers/pytorch_utils.py:117 in forward, code: x = x.view(size_out)
        view_62: "f16[1, 128, 768]" = torch.ops.aten.reshape.default(add_tensor_4, [1, 128, 768]);  add_tensor_4 = None
        ...
        convert_element_type_74: "f16[1, 128, 768]" = torch.ops.prims.convert_element_type.default(add_38, torch.float16);  add_38 = None
         ...
         # File: /usr/local/lib/python3.12/dist-packages/transformers/pytorch_utils.py:116 in forward, code: x = torch.addmm(self.bias, x.view(-1, x.size(-1)), self.weight)
        view_63: "f16[128, 768]" = torch.ops.aten.reshape.default(convert_element_type_74, [-1, 768]);  convert_element_type_74 = None
        addmm_18: "f16[128, 3072]" = torch.ops.aten.addmm.default(primals_61, view_63, primals_62);  primals_61 = None
        
         # File: /usr/local/lib/python3.12/dist-packages/transformers/pytorch_utils.py:117 in forward, code: x = x.view(size_out)
        view_64: "f16[1, 128, 3072]" = torch.ops.aten.reshape.default(addmm_18, [1, 128, 3072])
        ...
        mul_39: "f16[1, 128, 3072]" = torch.ops.aten.mul.Tensor(mul_36, add_40);  mul_36 = add_40 = None
         ...
         # File: /usr/local/lib/python3.12/dist-packages/transformers/pytorch_utils.py:116 in forward, code: x = torch.addmm(self.bias, x.view(-1, x.size(-1)), self.weight)
        view_65: "f16[128, 3072]" = torch.ops.aten.reshape.default(mul_39, [-1, 3072]);  mul_39 = None
        
        # No stacktrace found for following nodes
        mm_default_3: "f16[128, 768]" = torch.ops.aten.mm.default(view_65, primals_64)
        add_tensor_3: "f16[128, 768]" = torch.ops.aten.add.Tensor(mm_default_3, primals_63);  mm_default_3 = primals_63 = None
        
         # File: /usr/local/lib/python3.12/dist-packages/transformers/pytorch_utils.py:117 in forward, code: x = x.view(size_out)
        view_66: "f16[1, 128, 768]" = torch.ops.aten.reshape.default(add_tensor_3, [1, 128, 768]);  add_tensor_3 = None
        ...
        convert_element_type_82: "f16[1, 128, 768]" = torch.ops.prims.convert_element_type.default(add_43, torch.float16);  add_43 = None
         ...
         # File: /usr/local/lib/python3.12/dist-packages/transformers/pytorch_utils.py:116 in forward, code: x = torch.addmm(self.bias, x.view(-1, x.size(-1)), self.weight)
        view_67: "f16[128, 768]" = torch.ops.aten.reshape.default(convert_element_type_82, [-1, 768]);  convert_element_type_82 = None
        
        # No stacktrace found for following nodes
        mm_default_2: "f16[128, 2304]" = torch.ops.aten.mm.default(view_67, primals_68)
        add_tensor_2: "f16[128, 2304]" = torch.ops.aten.add.Tensor(mm_default_2, primals_67);  mm_default_2 = primals_67 = None
        
         # File: /usr/local/lib/python3.12/dist-packages/transformers/pytorch_utils.py:117 in forward, code: x = x.view(size_out)
        view_68: "f16[1, 128, 2304]" = torch.ops.aten.reshape.default(add_tensor_2, [1, 128, 2304]);  add_tensor_2 = None
        ...
        getitem_59: "f16[1, 128, 768]" = split_5[2];  split_5 = None
         ...
         # File: /usr/local/lib/python3.12/dist-packages/transformers/models/gpt2/modeling_gpt2.py:314 in forward, code: key_states = key_states.view(shape_kv).transpose(1, 2)
        view_69: "f16[1, 128, 12, 64]" = torch.ops.aten.reshape.default(getitem_58, [1, 128, -1, 64]);  getitem_58 = None
        permute_20: "f16[1, 12, 128, 64]" = torch.ops.aten.permute.default(view_69, [0, 2, 1, 3]);  view_69 = None
        
         # File: /usr/local/lib/python3.12/dist-packages/transformers/models/gpt2/modeling_gpt2.py:315 in forward, code: value_states = value_states.view(shape_kv).transpose(1, 2)
        view_70: "f16[1, 128, 12, 64]" = torch.ops.aten.reshape.default(getitem_59, [1, 128, -1, 64]);  getitem_59 = None
        permute_21: "f16[1, 12, 128, 64]" = torch.ops.aten.permute.default(view_70, [0, 2, 1, 3]);  view_70 = None
        
         # File: /usr/local/lib/python3.12/dist-packages/transformers/models/gpt2/modeling_gpt2.py:318 in forward, code: query_states = query_states.view(shape_q).transpose(1, 2)
        view_71: "f16[1, 128, 12, 64]" = torch.ops.aten.reshape.default(getitem_57, [1, 128, -1, 64]);  getitem_57 = None
        ...
        permute_23: "f16[1, 128, 12, 64]" = torch.ops.aten.permute.default(getitem_60, [0, 2, 1, 3])
         ...
         # File: /usr/local/lib/python3.12/dist-packages/transformers/models/gpt2/modeling_gpt2.py:356 in forward, code: attn_output = attn_output.reshape(*attn_output.shape[:-2], -1).contiguous()
        view_72: "f16[1, 128, 768]" = torch.ops.aten.reshape.default(permute_23, [1, 128, -1]);  permute_23 = None
        
         # File: /usr/local/lib/python3.12/dist-packages/transformers/pytorch_utils.py:116 in forward, code: x = torch.addmm(self.bias, x.view(-1, x.size(-1)), self.weight)
        view_73: "f16[128, 768]" = torch.ops.aten.reshape.default(view_72, [-1, 768]);  view_72 = None
        
        # No stacktrace found for following nodes
        mm_default_1: "f16[128, 768]" = torch.ops.aten.mm.default(view_73, primals_70);  view_73 = None
        add_tensor_1: "f16[128, 768]" = torch.ops.aten.add.Tensor(mm_default_1, primals_69);  mm_default_1 = primals_69 = None
        
         # File: /usr/local/lib/python3.12/dist-packages/transformers/pytorch_utils.py:117 in forward, code: x = x.view(size_out)
        view_74: "f16[1, 128, 768]" = torch.ops.aten.reshape.default(add_tensor_1, [1, 128, 768]);  add_tensor_1 = None
        ...
        convert_element_type_90: "f16[1, 128, 768]" = torch.ops.prims.convert_element_type.default(add_46, torch.float16);  add_46 = None
         ...
         # File: /usr/local/lib/python3.12/dist-packages/transformers/pytorch_utils.py:116 in forward, code: x = torch.addmm(self.bias, x.view(-1, x.size(-1)), self.weight)
        view_75: "f16[128, 768]" = torch.ops.aten.reshape.default(convert_element_type_90, [-1, 768]);  convert_element_type_90 = None
        addmm_22: "f16[128, 3072]" = torch.ops.aten.addmm.default(primals_73, view_75, primals_74);  primals_73 = None
        
         # File: /usr/local/lib/python3.12/dist-packages/transformers/pytorch_utils.py:117 in forward, code: x = x.view(size_out)
        view_76: "f16[1, 128, 3072]" = torch.ops.aten.reshape.default(addmm_22, [1, 128, 3072])
        ...
        mul_47: "f16[1, 128, 3072]" = torch.ops.aten.mul.Tensor(mul_44, add_48);  mul_44 = add_48 = None
         ...
         # File: /usr/local/lib/python3.12/dist-packages/transformers/pytorch_utils.py:116 in forward, code: x = torch.addmm(self.bias, x.view(-1, x.size(-1)), self.weight)
        view_77: "f16[128, 3072]" = torch.ops.aten.reshape.default(mul_47, [-1, 3072]);  mul_47 = None
        
        # No stacktrace found for following nodes
        mm_default: "f16[128, 768]" = torch.ops.aten.mm.default(view_77, primals_76)
        add_tensor: "f16[128, 768]" = torch.ops.aten.add.Tensor(mm_default, primals_75);  mm_default = primals_75 = None
        
         # File: /usr/local/lib/python3.12/dist-packages/transformers/pytorch_utils.py:117 in forward, code: x = x.view(size_out)
        view_78: "f16[1, 128, 768]" = torch.ops.aten.reshape.default(add_tensor, [1, 128, 768]);  add_tensor = None
        ...
        view_79: "f16[1, 128, 768]" = torch.ops.aten.reshape.default(convert_element_type_98, [-1, 128, 768]);  convert_element_type_98 = None
