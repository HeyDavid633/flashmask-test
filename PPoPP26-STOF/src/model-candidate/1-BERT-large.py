...
def bert_large_fwd_std():
    ...
    for layer in range(layer_num):
        ...
        # print("before trans q.shape: ", q.shape)
        ...
        print("hidden_states2 :", hidden_states.shape)
        exit()
...
if __name__ == '__main__':
    ...
    head_size = 64 # head_dim aka. head_size: 1024/16=64
    head_num = 16  # large 16
    layer_num = 24 # 24
    hidden_dim = head_num * head_size # 1024
    seq_len = 1024
    ...
    # print("BERT-large  |  bs:{}  |  seq:{}  |  Torch Naive    : {:.3f} ms / iter".format(batch_size, seq_len, base_time)) 
    
    # trace_BERT_large = torch.fx.symbolic_trace(fwd_bert_std)
    # print(trace_BERT_large.code)
