# python setup.py 89 build_ext --inplace
#
# A100:sm80 | 4090:sm89 | 3090:sm86
import os
import sys
import glob
...
extra_compile_args = {
    "nvcc" : ["-O3", "-w", "-I/usr/local/cuda/include", f"-gencode=arch=compute_{cuda_arch},code=sm_{cuda_arch}"]
}
extra_link_args = []
