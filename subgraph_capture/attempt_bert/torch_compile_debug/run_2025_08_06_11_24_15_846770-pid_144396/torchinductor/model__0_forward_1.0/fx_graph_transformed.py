class GraphModule(torch.nn.Module):
    def forward(self, primals_1: "i64[1, 128]", primals_2: "f16[30522, 768]", primals_3: "i64[1, 512]", primals_4: "f16[512, 768]", primals_5: "f16[768]", primals_6: "f16[768]", primals_7: "i64[1, 128]", primals_8: "f16[768, 768]", primals_9: "f16[768]", primals_10: "f16[768, 768]", primals_11: "f16[768]", primals_12: "f16[768, 768]", primals_13: "f16[768]", primals_14: "f16[768, 768]", primals_15: "f16[768]", primals_16: "f16[768]", primals_17: "f16[768]", primals_18: "f16[3072, 768]", primals_19: "f16[3072]", primals_20: "f16[768, 3072]", primals_21: "f16[768]", primals_22: "f16[768]", primals_23: "f16[768]", primals_24: "f16[768, 768]", primals_25: "f16[768]", primals_26: "f16[768, 768]", primals_27: "f16[768]", primals_28: "f16[768, 768]", primals_29: "f16[768]", primals_30: "f16[768, 768]", primals_31: "f16[768]", primals_32: "f16[768]", primals_33: "f16[768]", primals_34: "f16[3072, 768]", primals_35: "f16[3072]", primals_36: "f16[768, 3072]", primals_37: "f16[768]", primals_38: "f16[768]", primals_39: "f16[768]", primals_40: "f16[768, 768]", primals_41: "f16[768]", primals_42: "f16[768, 768]", primals_43: "f16[768]", primals_44: "f16[768, 768]", primals_45: "f16[768]", primals_46: "f16[768, 768]", primals_47: "f16[768]", primals_48: "f16[768]", primals_49: "f16[768]", primals_50: "f16[3072, 768]", primals_51: "f16[3072]", primals_52: "f16[768, 3072]", primals_53: "f16[768]", primals_54: "f16[768]", primals_55: "f16[768]", primals_56: "f16[768, 768]", primals_57: "f16[768]", primals_58: "f16[768, 768]", primals_59: "f16[768]", primals_60: "f16[768, 768]", primals_61: "f16[768]", primals_62: "f16[768, 768]", primals_63: "f16[768]", primals_64: "f16[768]", primals_65: "f16[768]", primals_66: "f16[3072, 768]", primals_67: "f16[3072]", primals_68: "f16[768, 3072]", primals_69: "f16[768]", primals_70: "f16[768]", primals_71: "f16[768]", primals_72: "f16[768, 768]", primals_73: "f16[768]", primals_74: "f16[768, 768]", primals_75: "f16[768]", primals_76: "f16[768, 768]", primals_77: "f16[768]", primals_78: "f16[768, 768]", primals_79: "f16[768]", primals_80: "f16[768]", primals_81: "f16[768]", primals_82: "f16[3072, 768]", primals_83: "f16[3072]", primals_84: "f16[768, 3072]", primals_85: "f16[768]", primals_86: "f16[768]", primals_87: "f16[768]", primals_88: "f16[768, 768]", primals_89: "f16[768]", primals_90: "f16[768, 768]", primals_91: "f16[768]", primals_92: "f16[768, 768]", primals_93: "f16[768]", primals_94: "f16[768, 768]", primals_95: "f16[768]", primals_96: "f16[768]", primals_97: "f16[768]", primals_98: "f16[3072, 768]", primals_99: "f16[3072]", primals_100: "f16[768, 3072]", primals_101: "f16[768]", primals_102: "f16[768]", primals_103: "f16[768]"):
        ...
        view: "f16[128, 768]" = torch.ops.aten.reshape.default(convert_element_type_1, [128, 768])
        ...
        view_1: "f16[1, 128, 768]" = torch.ops.aten.reshape.default(addmm, [1, 128, 768]);  addmm = None
        ...
        view_2: "f16[1, 128, 12, 64]" = torch.ops.aten.reshape.default(view_1, [1, -1, 12, 64]);  view_1 = None
        ...
        view_4: "f16[1, 128, 768]" = torch.ops.aten.reshape.default(addmm_1, [1, 128, 768]);  addmm_1 = None
        
         # File: /usr/local/lib/python3.10/dist-packages/transformers/models/distilbert/modeling_distilbert.py:384 in shape, code: return x.view(batch_size, -1, self.n_heads, dim_per_head).transpose(1, 2)
        view_5: "f16[1, 128, 12, 64]" = torch.ops.aten.reshape.default(view_4, [1, -1, 12, 64]);  view_4 = None
        ...
        view_7: "f16[1, 128, 768]" = torch.ops.aten.reshape.default(addmm_2, [1, 128, 768]);  addmm_2 = None
        
         # File: /usr/local/lib/python3.10/dist-packages/transformers/models/distilbert/modeling_distilbert.py:384 in shape, code: return x.view(batch_size, -1, self.n_heads, dim_per_head).transpose(1, 2)
        view_8: "f16[1, 128, 12, 64]" = torch.ops.aten.reshape.default(view_7, [1, -1, 12, 64]);  view_7 = None
        ...
        view_9: "f16[1, 128, 768]" = torch.ops.aten.reshape.default(permute_6, [1, -1, 768]);  permute_6 = None
        ...
        view_10: "f16[128, 768]" = torch.ops.aten.reshape.default(view_9, [128, 768]);  view_9 = None
        permute_7: "f16[768, 768]" = torch.ops.aten.permute.default(primals_14, [1, 0]);  primals_14 = None
        
        # No stacktrace found for following nodes
        mm_default_11: "f16[128, 768]" = torch.ops.aten.mm.default(view_10, permute_7);  view_10 = None
        add_tensor_11: "f16[128, 768]" = torch.ops.aten.add.Tensor(mm_default_11, primals_15);  mm_default_11 = primals_15 = None
        
         # File: /usr/local/lib/python3.10/dist-packages/transformers/models/distilbert/modeling_distilbert.py:412 in forward, code: attn_output = self.out_lin(attn_output)
        view_11: "f16[1, 128, 768]" = torch.ops.aten.reshape.default(add_tensor_11, [1, 128, 768]);  add_tensor_11 = None
        ...
        view_12: "f16[128, 768]" = torch.ops.aten.reshape.default(convert_element_type_17, [128, 768])
        ...
        view_13: "f16[1, 128, 3072]" = torch.ops.aten.reshape.default(addmm_4, [1, 128, 3072])
        ...
        view_14: "f16[128, 3072]" = torch.ops.aten.reshape.default(convert_element_type_22, [128, 3072]);  convert_element_type_22 = None
        permute_9: "f16[3072, 768]" = torch.ops.aten.permute.default(primals_20, [1, 0]);  primals_20 = None
        
        # No stacktrace found for following nodes
        mm_default_10: "f16[128, 768]" = torch.ops.aten.mm.default(view_14, permute_9)
        add_tensor_10: "f16[128, 768]" = torch.ops.aten.add.Tensor(mm_default_10, primals_21);  mm_default_10 = primals_21 = None
        
         # File: /usr/local/lib/python3.10/dist-packages/transformers/models/distilbert/modeling_distilbert.py:433 in ff_chunk, code: x = self.lin2(x)
        view_15: "f16[1, 128, 768]" = torch.ops.aten.reshape.default(add_tensor_10, [1, 128, 768]);  add_tensor_10 = None
        ...
        convert_element_type_27: "f16[1, 128, 768]" = torch.ops.prims.convert_element_type.default(add_9, torch.float16);  add_9 = None
         ...
         # File: /usr/local/lib/python3.10/dist-packages/transformers/models/distilbert/modeling_distilbert.py:390 in forward, code: q = shape(self.q_lin(query))  # (bs, n_heads, q_length, dim_per_head)
        view_16: "f16[128, 768]" = torch.ops.aten.reshape.default(convert_element_type_27, [128, 768])
        ...
        view_17: "f16[1, 128, 768]" = torch.ops.aten.reshape.default(addmm_6, [1, 128, 768]);  addmm_6 = None
        
         # File: /usr/local/lib/python3.10/dist-packages/transformers/models/distilbert/modeling_distilbert.py:384 in shape, code: return x.view(batch_size, -1, self.n_heads, dim_per_head).transpose(1, 2)
        view_18: "f16[1, 128, 12, 64]" = torch.ops.aten.reshape.default(view_17, [1, -1, 12, 64]);  view_17 = None
        ...
        view_20: "f16[1, 128, 768]" = torch.ops.aten.reshape.default(addmm_7, [1, 128, 768]);  addmm_7 = None
        
         # File: /usr/local/lib/python3.10/dist-packages/transformers/models/distilbert/modeling_distilbert.py:384 in shape, code: return x.view(batch_size, -1, self.n_heads, dim_per_head).transpose(1, 2)
        view_21: "f16[1, 128, 12, 64]" = torch.ops.aten.reshape.default(view_20, [1, -1, 12, 64]);  view_20 = None
        ...
        view_23: "f16[1, 128, 768]" = torch.ops.aten.reshape.default(addmm_8, [1, 128, 768]);  addmm_8 = None
        
         # File: /usr/local/lib/python3.10/dist-packages/transformers/models/distilbert/modeling_distilbert.py:384 in shape, code: return x.view(batch_size, -1, self.n_heads, dim_per_head).transpose(1, 2)
        view_24: "f16[1, 128, 12, 64]" = torch.ops.aten.reshape.default(view_23, [1, -1, 12, 64]);  view_23 = None
        ...
        view_25: "f16[1, 128, 768]" = torch.ops.aten.reshape.default(permute_16, [1, -1, 768]);  permute_16 = None
        
         # File: /usr/local/lib/python3.10/dist-packages/transformers/models/distilbert/modeling_distilbert.py:412 in forward, code: attn_output = self.out_lin(attn_output)
        view_26: "f16[128, 768]" = torch.ops.aten.reshape.default(view_25, [128, 768]);  view_25 = None
        permute_17: "f16[768, 768]" = torch.ops.aten.permute.default(primals_30, [1, 0]);  primals_30 = None
        
        # No stacktrace found for following nodes
        mm_default_9: "f16[128, 768]" = torch.ops.aten.mm.default(view_26, permute_17);  view_26 = None
        add_tensor_9: "f16[128, 768]" = torch.ops.aten.add.Tensor(mm_default_9, primals_31);  mm_default_9 = primals_31 = None
        
         # File: /usr/local/lib/python3.10/dist-packages/transformers/models/distilbert/modeling_distilbert.py:412 in forward, code: attn_output = self.out_lin(attn_output)
        view_27: "f16[1, 128, 768]" = torch.ops.aten.reshape.default(add_tensor_9, [1, 128, 768]);  add_tensor_9 = None
        ...
        convert_element_type_41: "f16[1, 128, 768]" = torch.ops.prims.convert_element_type.default(add_12, torch.float16);  add_12 = None
         ...
         # File: /usr/local/lib/python3.10/dist-packages/transformers/models/distilbert/modeling_distilbert.py:431 in ff_chunk, code: x = self.lin1(input)
        view_28: "f16[128, 768]" = torch.ops.aten.reshape.default(convert_element_type_41, [128, 768])
        ...
        view_29: "f16[1, 128, 3072]" = torch.ops.aten.reshape.default(addmm_10, [1, 128, 3072])
        ...
        convert_element_type_46: "f16[1, 128, 3072]" = torch.ops.prims.convert_element_type.default(mul_13, torch.float16);  mul_13 = None
         ...
         # File: /usr/local/lib/python3.10/dist-packages/transformers/models/distilbert/modeling_distilbert.py:433 in ff_chunk, code: x = self.lin2(x)
        view_30: "f16[128, 3072]" = torch.ops.aten.reshape.default(convert_element_type_46, [128, 3072]);  convert_element_type_46 = None
        permute_19: "f16[3072, 768]" = torch.ops.aten.permute.default(primals_36, [1, 0]);  primals_36 = None
        
        # No stacktrace found for following nodes
        mm_default_8: "f16[128, 768]" = torch.ops.aten.mm.default(view_30, permute_19)
        add_tensor_8: "f16[128, 768]" = torch.ops.aten.add.Tensor(mm_default_8, primals_37);  mm_default_8 = primals_37 = None
        
         # File: /usr/local/lib/python3.10/dist-packages/transformers/models/distilbert/modeling_distilbert.py:433 in ff_chunk, code: x = self.lin2(x)
        view_31: "f16[1, 128, 768]" = torch.ops.aten.reshape.default(add_tensor_8, [1, 128, 768]);  add_tensor_8 = None
        ...
        convert_element_type_51: "f16[1, 128, 768]" = torch.ops.prims.convert_element_type.default(add_16, torch.float16);  add_16 = None
         ...
         # File: /usr/local/lib/python3.10/dist-packages/transformers/models/distilbert/modeling_distilbert.py:390 in forward, code: q = shape(self.q_lin(query))  # (bs, n_heads, q_length, dim_per_head)
        view_32: "f16[128, 768]" = torch.ops.aten.reshape.default(convert_element_type_51, [128, 768])
        ...
        view_33: "f16[1, 128, 768]" = torch.ops.aten.reshape.default(addmm_12, [1, 128, 768]);  addmm_12 = None
        
         # File: /usr/local/lib/python3.10/dist-packages/transformers/models/distilbert/modeling_distilbert.py:384 in shape, code: return x.view(batch_size, -1, self.n_heads, dim_per_head).transpose(1, 2)
        view_34: "f16[1, 128, 12, 64]" = torch.ops.aten.reshape.default(view_33, [1, -1, 12, 64]);  view_33 = None
        ...
        view_36: "f16[1, 128, 768]" = torch.ops.aten.reshape.default(addmm_13, [1, 128, 768]);  addmm_13 = None
        
         # File: /usr/local/lib/python3.10/dist-packages/transformers/models/distilbert/modeling_distilbert.py:384 in shape, code: return x.view(batch_size, -1, self.n_heads, dim_per_head).transpose(1, 2)
        view_37: "f16[1, 128, 12, 64]" = torch.ops.aten.reshape.default(view_36, [1, -1, 12, 64]);  view_36 = None
        ...
        view_39: "f16[1, 128, 768]" = torch.ops.aten.reshape.default(addmm_14, [1, 128, 768]);  addmm_14 = None
        
         # File: /usr/local/lib/python3.10/dist-packages/transformers/models/distilbert/modeling_distilbert.py:384 in shape, code: return x.view(batch_size, -1, self.n_heads, dim_per_head).transpose(1, 2)
        view_40: "f16[1, 128, 12, 64]" = torch.ops.aten.reshape.default(view_39, [1, -1, 12, 64]);  view_39 = None
        ...
        view_41: "f16[1, 128, 768]" = torch.ops.aten.reshape.default(permute_26, [1, -1, 768]);  permute_26 = None
        
         # File: /usr/local/lib/python3.10/dist-packages/transformers/models/distilbert/modeling_distilbert.py:412 in forward, code: attn_output = self.out_lin(attn_output)
        view_42: "f16[128, 768]" = torch.ops.aten.reshape.default(view_41, [128, 768]);  view_41 = None
        permute_27: "f16[768, 768]" = torch.ops.aten.permute.default(primals_46, [1, 0]);  primals_46 = None
        
        # No stacktrace found for following nodes
        mm_default_7: "f16[128, 768]" = torch.ops.aten.mm.default(view_42, permute_27);  view_42 = None
        add_tensor_7: "f16[128, 768]" = torch.ops.aten.add.Tensor(mm_default_7, primals_47);  mm_default_7 = primals_47 = None
        
         # File: /usr/local/lib/python3.10/dist-packages/transformers/models/distilbert/modeling_distilbert.py:412 in forward, code: attn_output = self.out_lin(attn_output)
        view_43: "f16[1, 128, 768]" = torch.ops.aten.reshape.default(add_tensor_7, [1, 128, 768]);  add_tensor_7 = None
        ...
        convert_element_type_65: "f16[1, 128, 768]" = torch.ops.prims.convert_element_type.default(add_19, torch.float16);  add_19 = None
         ...
         # File: /usr/local/lib/python3.10/dist-packages/transformers/models/distilbert/modeling_distilbert.py:431 in ff_chunk, code: x = self.lin1(input)
        view_44: "f16[128, 768]" = torch.ops.aten.reshape.default(convert_element_type_65, [128, 768])
        ...
        view_45: "f16[1, 128, 3072]" = torch.ops.aten.reshape.default(addmm_16, [1, 128, 3072])
        ...
        convert_element_type_70: "f16[1, 128, 3072]" = torch.ops.prims.convert_element_type.default(mul_20, torch.float16);  mul_20 = None
         ...
         # File: /usr/local/lib/python3.10/dist-packages/transformers/models/distilbert/modeling_distilbert.py:433 in ff_chunk, code: x = self.lin2(x)
        view_46: "f16[128, 3072]" = torch.ops.aten.reshape.default(convert_element_type_70, [128, 3072]);  convert_element_type_70 = None
        permute_29: "f16[3072, 768]" = torch.ops.aten.permute.default(primals_52, [1, 0]);  primals_52 = None
        
        # No stacktrace found for following nodes
        mm_default_6: "f16[128, 768]" = torch.ops.aten.mm.default(view_46, permute_29)
        add_tensor_6: "f16[128, 768]" = torch.ops.aten.add.Tensor(mm_default_6, primals_53);  mm_default_6 = primals_53 = None
        
         # File: /usr/local/lib/python3.10/dist-packages/transformers/models/distilbert/modeling_distilbert.py:433 in ff_chunk, code: x = self.lin2(x)
        view_47: "f16[1, 128, 768]" = torch.ops.aten.reshape.default(add_tensor_6, [1, 128, 768]);  add_tensor_6 = None
        ...
        convert_element_type_75: "f16[1, 128, 768]" = torch.ops.prims.convert_element_type.default(add_23, torch.float16);  add_23 = None
         ...
         # File: /usr/local/lib/python3.10/dist-packages/transformers/models/distilbert/modeling_distilbert.py:390 in forward, code: q = shape(self.q_lin(query))  # (bs, n_heads, q_length, dim_per_head)
        view_48: "f16[128, 768]" = torch.ops.aten.reshape.default(convert_element_type_75, [128, 768])
        ...
        view_49: "f16[1, 128, 768]" = torch.ops.aten.reshape.default(addmm_18, [1, 128, 768]);  addmm_18 = None
        
         # File: /usr/local/lib/python3.10/dist-packages/transformers/models/distilbert/modeling_distilbert.py:384 in shape, code: return x.view(batch_size, -1, self.n_heads, dim_per_head).transpose(1, 2)
        view_50: "f16[1, 128, 12, 64]" = torch.ops.aten.reshape.default(view_49, [1, -1, 12, 64]);  view_49 = None
        ...
        view_52: "f16[1, 128, 768]" = torch.ops.aten.reshape.default(addmm_19, [1, 128, 768]);  addmm_19 = None
        
         # File: /usr/local/lib/python3.10/dist-packages/transformers/models/distilbert/modeling_distilbert.py:384 in shape, code: return x.view(batch_size, -1, self.n_heads, dim_per_head).transpose(1, 2)
        view_53: "f16[1, 128, 12, 64]" = torch.ops.aten.reshape.default(view_52, [1, -1, 12, 64]);  view_52 = None
        ...
        view_55: "f16[1, 128, 768]" = torch.ops.aten.reshape.default(addmm_20, [1, 128, 768]);  addmm_20 = None
        
         # File: /usr/local/lib/python3.10/dist-packages/transformers/models/distilbert/modeling_distilbert.py:384 in shape, code: return x.view(batch_size, -1, self.n_heads, dim_per_head).transpose(1, 2)
        view_56: "f16[1, 128, 12, 64]" = torch.ops.aten.reshape.default(view_55, [1, -1, 12, 64]);  view_55 = None
        ...
        view_57: "f16[1, 128, 768]" = torch.ops.aten.reshape.default(permute_36, [1, -1, 768]);  permute_36 = None
        
         # File: /usr/local/lib/python3.10/dist-packages/transformers/models/distilbert/modeling_distilbert.py:412 in forward, code: attn_output = self.out_lin(attn_output)
        view_58: "f16[128, 768]" = torch.ops.aten.reshape.default(view_57, [128, 768]);  view_57 = None
        permute_37: "f16[768, 768]" = torch.ops.aten.permute.default(primals_62, [1, 0]);  primals_62 = None
        
        # No stacktrace found for following nodes
        mm_default_5: "f16[128, 768]" = torch.ops.aten.mm.default(view_58, permute_37);  view_58 = None
        add_tensor_5: "f16[128, 768]" = torch.ops.aten.add.Tensor(mm_default_5, primals_63);  mm_default_5 = primals_63 = None
        
         # File: /usr/local/lib/python3.10/dist-packages/transformers/models/distilbert/modeling_distilbert.py:412 in forward, code: attn_output = self.out_lin(attn_output)
        view_59: "f16[1, 128, 768]" = torch.ops.aten.reshape.default(add_tensor_5, [1, 128, 768]);  add_tensor_5 = None
        ...
        convert_element_type_89: "f16[1, 128, 768]" = torch.ops.prims.convert_element_type.default(add_26, torch.float16);  add_26 = None
         ...
         # File: /usr/local/lib/python3.10/dist-packages/transformers/models/distilbert/modeling_distilbert.py:431 in ff_chunk, code: x = self.lin1(input)
        view_60: "f16[128, 768]" = torch.ops.aten.reshape.default(convert_element_type_89, [128, 768])
        ...
        view_61: "f16[1, 128, 3072]" = torch.ops.aten.reshape.default(addmm_22, [1, 128, 3072])
        ...
        convert_element_type_94: "f16[1, 128, 3072]" = torch.ops.prims.convert_element_type.default(mul_27, torch.float16);  mul_27 = None
         ...
         # File: /usr/local/lib/python3.10/dist-packages/transformers/models/distilbert/modeling_distilbert.py:433 in ff_chunk, code: x = self.lin2(x)
        view_62: "f16[128, 3072]" = torch.ops.aten.reshape.default(convert_element_type_94, [128, 3072]);  convert_element_type_94 = None
        permute_39: "f16[3072, 768]" = torch.ops.aten.permute.default(primals_68, [1, 0]);  primals_68 = None
        
        # No stacktrace found for following nodes
        mm_default_4: "f16[128, 768]" = torch.ops.aten.mm.default(view_62, permute_39)
        add_tensor_4: "f16[128, 768]" = torch.ops.aten.add.Tensor(mm_default_4, primals_69);  mm_default_4 = primals_69 = None
        
         # File: /usr/local/lib/python3.10/dist-packages/transformers/models/distilbert/modeling_distilbert.py:433 in ff_chunk, code: x = self.lin2(x)
        view_63: "f16[1, 128, 768]" = torch.ops.aten.reshape.default(add_tensor_4, [1, 128, 768]);  add_tensor_4 = None
        ...
        convert_element_type_99: "f16[1, 128, 768]" = torch.ops.prims.convert_element_type.default(add_30, torch.float16);  add_30 = None
         ...
         # File: /usr/local/lib/python3.10/dist-packages/transformers/models/distilbert/modeling_distilbert.py:390 in forward, code: q = shape(self.q_lin(query))  # (bs, n_heads, q_length, dim_per_head)
        view_64: "f16[128, 768]" = torch.ops.aten.reshape.default(convert_element_type_99, [128, 768])
        ...
        view_65: "f16[1, 128, 768]" = torch.ops.aten.reshape.default(addmm_24, [1, 128, 768]);  addmm_24 = None
        
         # File: /usr/local/lib/python3.10/dist-packages/transformers/models/distilbert/modeling_distilbert.py:384 in shape, code: return x.view(batch_size, -1, self.n_heads, dim_per_head).transpose(1, 2)
        view_66: "f16[1, 128, 12, 64]" = torch.ops.aten.reshape.default(view_65, [1, -1, 12, 64]);  view_65 = None
        ...
        view_68: "f16[1, 128, 768]" = torch.ops.aten.reshape.default(addmm_25, [1, 128, 768]);  addmm_25 = None
        
         # File: /usr/local/lib/python3.10/dist-packages/transformers/models/distilbert/modeling_distilbert.py:384 in shape, code: return x.view(batch_size, -1, self.n_heads, dim_per_head).transpose(1, 2)
        view_69: "f16[1, 128, 12, 64]" = torch.ops.aten.reshape.default(view_68, [1, -1, 12, 64]);  view_68 = None
        ...
        view_71: "f16[1, 128, 768]" = torch.ops.aten.reshape.default(addmm_26, [1, 128, 768]);  addmm_26 = None
        
         # File: /usr/local/lib/python3.10/dist-packages/transformers/models/distilbert/modeling_distilbert.py:384 in shape, code: return x.view(batch_size, -1, self.n_heads, dim_per_head).transpose(1, 2)
        view_72: "f16[1, 128, 12, 64]" = torch.ops.aten.reshape.default(view_71, [1, -1, 12, 64]);  view_71 = None
        ...
        view_73: "f16[1, 128, 768]" = torch.ops.aten.reshape.default(permute_46, [1, -1, 768]);  permute_46 = None
        
         # File: /usr/local/lib/python3.10/dist-packages/transformers/models/distilbert/modeling_distilbert.py:412 in forward, code: attn_output = self.out_lin(attn_output)
        view_74: "f16[128, 768]" = torch.ops.aten.reshape.default(view_73, [128, 768]);  view_73 = None
        permute_47: "f16[768, 768]" = torch.ops.aten.permute.default(primals_78, [1, 0]);  primals_78 = None
        
        # No stacktrace found for following nodes
        mm_default_3: "f16[128, 768]" = torch.ops.aten.mm.default(view_74, permute_47);  view_74 = None
        add_tensor_3: "f16[128, 768]" = torch.ops.aten.add.Tensor(mm_default_3, primals_79);  mm_default_3 = primals_79 = None
        
         # File: /usr/local/lib/python3.10/dist-packages/transformers/models/distilbert/modeling_distilbert.py:412 in forward, code: attn_output = self.out_lin(attn_output)
        view_75: "f16[1, 128, 768]" = torch.ops.aten.reshape.default(add_tensor_3, [1, 128, 768]);  add_tensor_3 = None
        ...
        convert_element_type_113: "f16[1, 128, 768]" = torch.ops.prims.convert_element_type.default(add_33, torch.float16);  add_33 = None
         ...
         # File: /usr/local/lib/python3.10/dist-packages/transformers/models/distilbert/modeling_distilbert.py:431 in ff_chunk, code: x = self.lin1(input)
        view_76: "f16[128, 768]" = torch.ops.aten.reshape.default(convert_element_type_113, [128, 768])
        ...
        view_77: "f16[1, 128, 3072]" = torch.ops.aten.reshape.default(addmm_28, [1, 128, 3072])
        ...
        convert_element_type_118: "f16[1, 128, 3072]" = torch.ops.prims.convert_element_type.default(mul_34, torch.float16);  mul_34 = None
         ...
         # File: /usr/local/lib/python3.10/dist-packages/transformers/models/distilbert/modeling_distilbert.py:433 in ff_chunk, code: x = self.lin2(x)
        view_78: "f16[128, 3072]" = torch.ops.aten.reshape.default(convert_element_type_118, [128, 3072]);  convert_element_type_118 = None
        permute_49: "f16[3072, 768]" = torch.ops.aten.permute.default(primals_84, [1, 0]);  primals_84 = None
        
        # No stacktrace found for following nodes
        mm_default_2: "f16[128, 768]" = torch.ops.aten.mm.default(view_78, permute_49)
        add_tensor_2: "f16[128, 768]" = torch.ops.aten.add.Tensor(mm_default_2, primals_85);  mm_default_2 = primals_85 = None
        
         # File: /usr/local/lib/python3.10/dist-packages/transformers/models/distilbert/modeling_distilbert.py:433 in ff_chunk, code: x = self.lin2(x)
        view_79: "f16[1, 128, 768]" = torch.ops.aten.reshape.default(add_tensor_2, [1, 128, 768]);  add_tensor_2 = None
        ...
        convert_element_type_123: "f16[1, 128, 768]" = torch.ops.prims.convert_element_type.default(add_37, torch.float16);  add_37 = None
         ...
         # File: /usr/local/lib/python3.10/dist-packages/transformers/models/distilbert/modeling_distilbert.py:390 in forward, code: q = shape(self.q_lin(query))  # (bs, n_heads, q_length, dim_per_head)
        view_80: "f16[128, 768]" = torch.ops.aten.reshape.default(convert_element_type_123, [128, 768])
        ...
        view_81: "f16[1, 128, 768]" = torch.ops.aten.reshape.default(addmm_30, [1, 128, 768]);  addmm_30 = None
        
         # File: /usr/local/lib/python3.10/dist-packages/transformers/models/distilbert/modeling_distilbert.py:384 in shape, code: return x.view(batch_size, -1, self.n_heads, dim_per_head).transpose(1, 2)
        view_82: "f16[1, 128, 12, 64]" = torch.ops.aten.reshape.default(view_81, [1, -1, 12, 64]);  view_81 = None
        ...
        view_84: "f16[1, 128, 768]" = torch.ops.aten.reshape.default(addmm_31, [1, 128, 768]);  addmm_31 = None
        
         # File: /usr/local/lib/python3.10/dist-packages/transformers/models/distilbert/modeling_distilbert.py:384 in shape, code: return x.view(batch_size, -1, self.n_heads, dim_per_head).transpose(1, 2)
        view_85: "f16[1, 128, 12, 64]" = torch.ops.aten.reshape.default(view_84, [1, -1, 12, 64]);  view_84 = None
        ...
        view_87: "f16[1, 128, 768]" = torch.ops.aten.reshape.default(addmm_32, [1, 128, 768]);  addmm_32 = None
        
         # File: /usr/local/lib/python3.10/dist-packages/transformers/models/distilbert/modeling_distilbert.py:384 in shape, code: return x.view(batch_size, -1, self.n_heads, dim_per_head).transpose(1, 2)
        view_88: "f16[1, 128, 12, 64]" = torch.ops.aten.reshape.default(view_87, [1, -1, 12, 64]);  view_87 = None
        ...
        view_89: "f16[1, 128, 768]" = torch.ops.aten.reshape.default(permute_56, [1, -1, 768]);  permute_56 = None
        
         # File: /usr/local/lib/python3.10/dist-packages/transformers/models/distilbert/modeling_distilbert.py:412 in forward, code: attn_output = self.out_lin(attn_output)
        view_90: "f16[128, 768]" = torch.ops.aten.reshape.default(view_89, [128, 768]);  view_89 = None
        permute_57: "f16[768, 768]" = torch.ops.aten.permute.default(primals_94, [1, 0]);  primals_94 = None
        
        # No stacktrace found for following nodes
        mm_default_1: "f16[128, 768]" = torch.ops.aten.mm.default(view_90, permute_57);  view_90 = None
        add_tensor_1: "f16[128, 768]" = torch.ops.aten.add.Tensor(mm_default_1, primals_95);  mm_default_1 = primals_95 = None
        
         # File: /usr/local/lib/python3.10/dist-packages/transformers/models/distilbert/modeling_distilbert.py:412 in forward, code: attn_output = self.out_lin(attn_output)
        view_91: "f16[1, 128, 768]" = torch.ops.aten.reshape.default(add_tensor_1, [1, 128, 768]);  add_tensor_1 = None
        ...
        convert_element_type_137: "f16[1, 128, 768]" = torch.ops.prims.convert_element_type.default(add_40, torch.float16);  add_40 = None
         ...
         # File: /usr/local/lib/python3.10/dist-packages/transformers/models/distilbert/modeling_distilbert.py:431 in ff_chunk, code: x = self.lin1(input)
        view_92: "f16[128, 768]" = torch.ops.aten.reshape.default(convert_element_type_137, [128, 768])
        ...
        view_93: "f16[1, 128, 3072]" = torch.ops.aten.reshape.default(addmm_34, [1, 128, 3072])
        ...
        convert_element_type_142: "f16[1, 128, 3072]" = torch.ops.prims.convert_element_type.default(mul_41, torch.float16);  mul_41 = None
         ...
         # File: /usr/local/lib/python3.10/dist-packages/transformers/models/distilbert/modeling_distilbert.py:433 in ff_chunk, code: x = self.lin2(x)
        view_94: "f16[128, 3072]" = torch.ops.aten.reshape.default(convert_element_type_142, [128, 3072]);  convert_element_type_142 = None
        permute_59: "f16[3072, 768]" = torch.ops.aten.permute.default(primals_100, [1, 0]);  primals_100 = None
        
        # No stacktrace found for following nodes
        mm_default: "f16[128, 768]" = torch.ops.aten.mm.default(view_94, permute_59)
        add_tensor: "f16[128, 768]" = torch.ops.aten.add.Tensor(mm_default, primals_101);  mm_default = primals_101 = None
        
         # File: /usr/local/lib/python3.10/dist-packages/transformers/models/distilbert/modeling_distilbert.py:433 in ff_chunk, code: x = self.lin2(x)
        view_95: "f16[1, 128, 768]" = torch.ops.aten.reshape.default(add_tensor, [1, 128, 768]);  add_tensor = None
