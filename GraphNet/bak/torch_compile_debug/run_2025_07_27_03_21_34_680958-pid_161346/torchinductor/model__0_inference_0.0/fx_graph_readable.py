class <lambda>(torch.nn.Module):
    def forward(self, arg0_1: "f16[1, 128, 768]", arg1_1: "f16[768, 2304]", arg2_1: "f16[2304]", arg3_1: "f32[1, 128, 128]", arg4_1: "f16[768, 768]", arg5_1: "f16[768]", arg6_1: "f16[768]", arg7_1: "f16[768]", arg8_1: "f16[768, 3072]", arg9_1: "f16[3072]", arg10_1: "f16[3072, 768]", arg11_1: "f16[768]", arg12_1: "f16[768]", arg13_1: "f16[768]"):
        ...
        view: "f16[128, 768]" = torch.ops.aten.view.default(arg0_1, [128, 768])
        mm: "f16[128, 2304]" = torch.ops.aten.mm.default(view, arg1_1);  view = arg1_1 = None
        view_1: "f16[1, 128, 2304]" = torch.ops.aten.view.default(mm, [1, 128, 2304]);  mm = None
        ...
        view_2: "f16[1, 128, 12, 64]" = torch.ops.aten.view.default(getitem, [1, 128, 12, 64]);  getitem = None
        ...
        permute: "f16[1, 12, 128, 64]" = torch.ops.aten.permute.default(view_2, [0, 2, 1, 3]);  view_2 = None
         ...
         # File: /flashmask-test/GraphNet/bak/util/utils.py:35 in transpose_for_scores, code: x = x.view(new_x_shape)
        view_3: "f16[1, 128, 12, 64]" = torch.ops.aten.view.default(getitem_1, [1, 128, 12, 64]);  getitem_1 = None
        
         # File: /flashmask-test/GraphNet/bak/util/utils.py:38 in transpose_for_scores, code: return x.permute(0, 2, 1, 3)
        permute_1: "f16[1, 12, 128, 64]" = torch.ops.aten.permute.default(view_3, [0, 2, 1, 3]);  view_3 = None
        
         # File: /flashmask-test/GraphNet/bak/util/utils.py:35 in transpose_for_scores, code: x = x.view(new_x_shape)
        view_4: "f16[1, 128, 12, 64]" = torch.ops.aten.view.default(getitem_2, [1, 128, 12, 64]);  getitem_2 = None
        ...
        view_5: "f16[12, 128, 64]" = torch.ops.aten.view.default(expand, [12, 128, 64]);  expand = None
        expand_1: "f16[1, 12, 64, 128]" = torch.ops.aten.expand.default(permute_3, [1, 12, 64, 128]);  permute_3 = None
        view_6: "f16[12, 64, 128]" = torch.ops.aten.view.default(expand_1, [12, 64, 128]);  expand_1 = None
        bmm: "f16[12, 128, 128]" = torch.ops.aten.bmm.default(view_5, view_6);  view_5 = view_6 = None
        view_7: "f16[1, 12, 128, 128]" = torch.ops.aten.view.default(bmm, [1, 12, 128, 128]);  bmm = None
        ...
        convert_element_type_default: "f32[1, 12, 128, 128]" = torch.ops.prims.convert_element_type.default(sub_1, torch.float32);  sub_1 = None
        amax: "f32[1, 12, 128, 1]" = torch.ops.aten.amax.default(convert_element_type_default, [-1], True)
        sub_2: "f32[1, 12, 128, 128]" = torch.ops.aten.sub.Tensor(convert_element_type_default, amax);  convert_element_type_default = amax = None
        ...
        view_8: "f16[12, 128, 128]" = torch.ops.aten.view.default(expand_2, [12, 128, 128]);  expand_2 = None
        expand_3: "f16[1, 12, 128, 64]" = torch.ops.aten.expand.default(permute_2, [1, 12, 128, 64]);  permute_2 = None
        view_9: "f16[12, 128, 64]" = torch.ops.aten.view.default(expand_3, [12, 128, 64]);  expand_3 = None
        bmm_1: "f16[12, 128, 64]" = torch.ops.aten.bmm.default(view_8, view_9);  view_8 = view_9 = None
        view_10: "f16[1, 12, 128, 64]" = torch.ops.aten.view.default(bmm_1, [1, 12, 128, 64]);  bmm_1 = None
        ...
        view_11: "f16[1, 128, 768]" = torch.ops.aten.view.default(clone, [1, 128, 768]);  clone = None
        ...
        view_12: "f16[128, 768]" = torch.ops.aten.view.default(view_11, [128, 768]);  view_11 = None
        mm_1: "f16[128, 768]" = torch.ops.aten.mm.default(view_12, arg4_1);  view_12 = arg4_1 = None
        view_13: "f16[1, 128, 768]" = torch.ops.aten.view.default(mm_1, [1, 128, 768]);  mm_1 = None
        ...
        view_14: "f16[128, 768]" = torch.ops.aten.view.default(convert_element_type_12, [128, 768])
        mm_2: "f16[128, 3072]" = torch.ops.aten.mm.default(view_14, arg8_1);  view_14 = arg8_1 = None
        view_15: "f16[1, 128, 3072]" = torch.ops.aten.view.default(mm_2, [1, 128, 3072]);  mm_2 = None
        ...
        view_16: "f16[128, 3072]" = torch.ops.aten.view.default(convert_element_type_16, [128, 3072]);  convert_element_type_16 = None
        mm_3: "f16[128, 768]" = torch.ops.aten.mm.default(view_16, arg10_1);  view_16 = arg10_1 = None
        view_17: "f16[1, 128, 768]" = torch.ops.aten.view.default(mm_3, [1, 128, 768]);  mm_3 = None
