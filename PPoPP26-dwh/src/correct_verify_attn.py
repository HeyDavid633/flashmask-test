...
if __name__ == "__main__":
    ...
    if(test_ByteTrans):
        ...
        # query_byte = transpose_for_scores2(query_byte, head_num, head_size)
        # key_byte = transpose_for_scores2(key_byte, head_num, head_size)
        # value_byte = transpose_for_scores2(value_byte, head_num, head_size)
    ...
    # torch_output_byte = torch_attn_std(query_byte, key_byte, value_byte, dropout_p=dropout_p, causal=is_causal)
