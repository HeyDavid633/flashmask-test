...
def plot_performance(data_list, subtitles, gpu_info):
    ...
    label_name=['PyTorch Native', 'MCFuser', 'ByteTransformer', 'FA2', 'FlexAttention', 'STOF']
...
# python fig10-11.py --file_path1="fig_10_11_mask_1.txt" \
#                     --file_path2="fig_10_11_mask_4.txt" \
#                     --file_path3="fig_10_11_mask_2.txt" \
#                     --file_path4="fig_10_11_mask_3.txt"
def main():
    parser = argparse.ArgumentParser(description='Plot MHA performance')
    parser.add_argument('--file_path1', default="2fig_10_11_mask_0A100.txt",)
    parser.add_argument('--file_path2', default="2fig_10_11_mask_1A100.txt",)
    parser.add_argument('--file_path3', default="2fig_10_11_mask_2A100.txt",)
    parser.add_argument('--file_path4', default="2fig_10_11_mask_3A100.txt",)
    parser.add_argument('--onlymc_file_path', default="attn_perf_only_MCFuser_A100.txt",type=str, help='Path to the input onlymc_txt file.')
