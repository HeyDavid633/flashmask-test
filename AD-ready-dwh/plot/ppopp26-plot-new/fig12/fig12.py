...
# parser.add_argument('--mcfuser_4090', default="4090mcfuser.txt", help="Path to MCFuser 4090 log file")
parser.add_argument('--all_4090', default="all_4090.txt", help="Path to STOF other 4090 data file")
# parser.add_argument('--stof_4090', default="../../data/End2End_Performance/4090stof.txt", help="Path to STOF 4090 data file")
parser.add_argument('--bolt_4090', default="4090bolt.txt", help="Path to Bolt 4090 data file")
parser.add_argument('--mcfuser_a100', default="a100mcfuser.txt", help="Path to MCFuser A100 log file")
parser.add_argument('--all_a100', default="all_A100.txt", help="Path to STOF other A100 data file")
# parser.add_argument('--stof_a100', default="../../data/End2End_Performance/a100stof.txt", help="Path to STOF A100 data file")
parser.add_argument('--bolt_a100', default="a100bolt.txt", help="Path to Bolt A100 data file")
args = parser.parse_args()
# data1 = parse_file2(args.mcfuser_4090,is_mcfuser=True)
data1 = parse_file2(args.all_4090)
# data3 = parse_file2(args.stof_4090)
data2 = parse_file(args.bolt_4090)

# data4 = parse_file(args.mcfuser_a100,is_mcfuser=True)
data3 = parse_file2(args.all_a100)
# # data7 = parse_file2(args.stof_a100)
data4 = parse_file(args.bolt_a100)
...
combined_data2=combinedData(data3,data4)
...
plt.savefig('5-eva-EE-4090-A100.pdf',
            bbox_inches='tight',
            dpi=300,
            facecolor='white')
