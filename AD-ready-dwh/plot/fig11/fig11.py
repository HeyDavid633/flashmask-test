...
parser.add_argument('--all_4090', default="../../data/End2End_Performance/all_4090.txt", help="Path to STOF other 4090 data file")
parser.add_argument('--bolt_4090', default="../../data/End2End_Performance/4090bolt.txt", help="Path to Bolt 4090 data file")
parser.add_argument('--all_a100', default="../../data/End2End_Performance/all_A100.txt", help="Path to STOF other A100 data file")
