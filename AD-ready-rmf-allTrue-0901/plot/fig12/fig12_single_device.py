...
parser.add_argument('--mcfuser_device', default="../../data/End2End_Performance/4090mcfuser.txt", help="Path to MCFuser 4090 log file")
parser.add_argument('--stof_other_device', default="../../data/End2End_Performance/4090stof_other.txt", help="Path to STOF other 4090 data file")
parser.add_argument('--stof_device', default="../../data/End2End_Performance/4090stof.txt", help="Path to STOF 4090 data file")
parser.add_argument('--bolt_device', default="../../data/End2End_Performance/4090bolt.txt", help="Path to Bolt 4090 data file")
args = parser.parse_args()

data1 = parse_file(args.mcfuser_device, is_mcfuser=True)
data2 = parse_file2(args.stof_other_device)
data3 = parse_file2(args.stof_device)
data4 = parse_file(args.bolt_device)


# Combine and normalize data
combined_data = combinedData(data1, data2, data3, data4)
normalized_data = normalizedData(combined_data)
...
data = extract_data(normalized_data)
...
plt.tight_layout()
plt.savefig('fig12_single_device.pdf',
           bbox_inches='tight',
           dpi=300,
           facecolor='white')
